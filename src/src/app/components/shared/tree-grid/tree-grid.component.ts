...
import { TreeChanges } from 'src/app/common/types/tree-changes.interface';
import { Tree } from 'src/app/common/types/tree-interface'; 
...
export class TreeGridComponent implements OnChanges {
	...
	handleRowToggle(event) {
		console.log('handleRowToggle', event);
	}
